...
// define the memory manager for the application
extern void* mallocOverloaded(unsigned int);
extern void freeOverloaded(void*);

extern void* mallocString(unsigned int,unsigned int);
