...
# else
#  define __size_type__        typename hashtable<_Val, _Key, _HF, _ExK, _EqK, _All>::size_type
#  define __reference__        typename  hashtable<_Val, _Key, _HF, _ExK, _EqK, _All>::reference
#  define __iterator__         typename hashtable<_Val, _Key, _HF, _ExK, _EqK, _All>::iterator
# endif
