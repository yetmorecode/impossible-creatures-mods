...
// Sigma Setup
# define _STLP_NEW mallocOverloaded
# define _STLP_PLACEMENT_NEW new

# define _STLP_DELETE freeOverloaded
# define _STLP_PLACEMENT_DELETE delete
...
// Sigma -- Modified _STLP_STD to stlport instead of _STL
#  if defined (_STLP_USE_OWN_NAMESPACE)
#   define _STLP_STD      _stlport
#  else
#   ifdef _STLP_DEBUG
namespace stdD = std;
#   endif
